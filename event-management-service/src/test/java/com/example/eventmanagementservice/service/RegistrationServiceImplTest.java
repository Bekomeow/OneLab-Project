...
//
//    @Test
//    void registerUserForEvent_ShouldRegisterSuccessfully() {
//        event.setRegistrations(new ArrayList<>());
//        when(eventRepository.findById(1L)).thenReturn(Optional.of(event));
//        when(registrationRepository.save(any(Registration.class))).thenReturn(registration);
//
//        Registration result = registrationService.registerUserForEvent(1L, "test@example.com", 1L);
//
//        assertThat(result).isNotNull();
//        assertThat(result.getUserId()).isEqualTo(1L);
//        verify(ticketService, times(1)).generateTicket(1L, event);
//        verify(kafkaTemplate, times(1)).send(eq("event.registration.created"), any(EventRegistration.class));
//    }
//
//    @Test
...
//
//        assertThatThrownBy(() -> registrationService.registerUserForEvent(1L, "test@example.com", 1L))
