...
//        when(ticketRepository.existsByUserIdAndEvent(1L, event)).thenReturn(false);
//        when(ticketRepository.save(any(Ticket.class))).thenReturn(ticket);
//
//        Ticket result = ticketService.generateTicket(1L, event);
//
...
//        when(ticketRepository.existsByUserIdAndEvent(1L, event)).thenReturn(true);
//
//        assertThatThrownBy(() -> ticketService.generateTicket(1L, event))
